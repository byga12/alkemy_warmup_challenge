...
//redux
import { toggleAddModes, toggleEditModes } from '../../store/slices/mode';
...
export default function Sidebar() {
  ...
  //cada vez que se renderiza sidebar, chequea si hay un token en el contexto global, si no hay nos manda al login
  ...
  const toggleAddMode = () => {
    dispatch(toggleAddModes())
  }
  
  const toggleEditMode = () => {
    dispatch(toggleEditModes())
  }
  const logout = () => {
